    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../" class="logo">
          ...
          <span class="logo-mini"><b>Ad</b>My</span>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.desarrolladormadrid.com - Desarrollando Software
                      <small>Luis Vázquez</small>
                    </p>
                  </li>
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu ">
            ...
            if ($_SESSION['escritorio']==1)
            {
              echo '<li id="kpis">
              <a href="escritorio.php">
                <i class="fa fa-tasks"></i> <span>Kpis</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
              <li id="kpidiario"><a href="ventasfechacliente.php"><i class="fa fa-circle-o"></i>Kpi Diario</a></li>
              <li id="kpipromedio"><a href="ventasfechacliente.php"><i class="fa fa-circle-o"></i>Kpi Promedio</a></li>                
            </ul>
            </li>';
            }
            ?>
            ...
            if ($_SESSION['escritorio']==1)
            {
              echo '<li id="stock">
              <a href="escritorio.php">
                <i class="fa fa-tasks"></i> <span>Stock</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
              <li id="kpidiario"><a href="ventasfechacliente.php"><i class="fa fa-circle-o"></i>Tienda 1</a></li>
              <li id="kpipromedio"><a href="ventasfechacliente.php"><i class="fa fa-circle-o"></i>Tienda 2</a></li>                
            </ul>
            </li>';
            }
            ?>
